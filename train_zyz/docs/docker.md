...
```bash
docker login --username=nick0634872703 crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com
```
...
```bash
docker pull crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:[镜像版本号]
```
...
# 给本地镜像打 ACR tag
docker tag [ImageId] crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:[镜像版本号]

# 推送
docker push crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:[镜像版本号]
```
...
```
crpi-32rssczyu25r10yu-vpc.cn-beijing.personal.cr.aliyuncs.com
```
...
# crpi-.../zyz25/sft-base                         v1        abc123def456

# 重新打 tag 并推送
docker tag abc123def456 crpi-32rssczyu25r10yu-vpc.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:v1
docker push crpi-32rssczyu25r10yu-vpc.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:v1
```
...
```cmd
push_to_acr.cmd -u nick0634872703 -p your_password
```
...
| 配置项 | 值 |
|--------|-----|
| Registry | `crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com` |
| 命名空间 | `zyz25` |
| 仓库 | `sft-base` |
| 当前 Tag | `v1` |
| 镜像全称 | `crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:v1` |
| Magnus URI | `docker://crpi-32rssczyu25r10yu.cn-beijing.personal.cr.aliyuncs.com/zyz25/sft-base:v1` |
