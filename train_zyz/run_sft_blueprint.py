...
from config import MAGNUS_ADDRESS, MAGNUS_TOKEN, auto_source, notify_exe, wait_for_job
...
def main():
    ...
    # 读取 .magnus 文件
    magnus_path = os.path.join(HERE, "blueprints", "OpenFundus_SFT_zyz.magnus")
    ...
    wait_for_job(job_id, poll_interval=60)
    print()
